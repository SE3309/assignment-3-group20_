...
CREATE TABLE `paycheck` (
  ...
  KEY `refID` (`refID`),
  CONSTRAINT `paycheck_ibfk_1` FOREIGN KEY (`refID`) REFERENCES `referee` (`refID`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `paycheck` VALUES (11,'R001',NULL,'2025-12-10',220),(12,'R003',NULL,'2025-12-10',110),(13,'R002',NULL,'2025-12-31',400),(14,'R004',NULL,'2025-12-31',350),(15,'R005','2025-09-25','2025-10-31',350);
